...
import BathbodyAccordion from "./BathbodyAccordion";
import BathbodyRelatedProducts from "./BathbodyRelatedProducts";

export default function Bathbodyinfo() {
    const { id } = useParams();
    ...
    const { setIsCartOpen, setIsWishlistOpen, wishlistCount,} = useContext(Context);
    ...
    return (
        <Layout>
            <div className="max-w-5xl mx-auto p-10 grid md:grid-cols-2 gap-8">
                <div className="relative">
                    ...
                    <button
                        ...
                        {isInWishlist ? <FaHeart className="text-red-500 text-2xl" /> : <FaRegHeart className="text-black text-2xl" />}
                    </button>

                    <div className="mt-4 flex items-center gap-2">
                        <button onClick={() => scroll("left")} className="p-2 text-2xl text-gray-400">&lt;</button>
                        <div ref={scrollRef} className="flex gap-2 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-200 shadow-md px-2 py-1 rounded">
                ...
                <div className="px-5">
                    ...
                    <button
                        ...
                        className="mt-5 w-full text-white text-sm font-semibold uppercase py-2 border border-black bg-gradient-to-r from-black to-gray-800 hover:from-gray-800 hover:to-black"
                    >
                        Add to Cart
                    </button>
            ...
            <BathbodyAccordion product={product} />

            <BathbodyRelatedProducts products={relatedProducts} handleAddToCart={handleAddToCart} wishlistItems={wishlistItems} addToWishlist={addToWishlist} />
