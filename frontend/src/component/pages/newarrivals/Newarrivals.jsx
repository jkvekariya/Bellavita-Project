...
const Newarrivals = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      setProducts(data);
      const newArrivals = data.filter((p) => p.category === "NewArrivals");
      setProducts(newArrivals);
      setFilteredSortedProducts(newArrivals);
    } catch (error) {
  ...
  return (
    <Layout>
      <div className="p-6 max-w-6xl mx-auto mt-8">
        <h1 className="text-center mb-5 text-2xl font-semibold">New Arrivals</h1>
